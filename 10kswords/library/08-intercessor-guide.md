...
The Intercessor is **not** a storyteller or novelist. There is no story to be told. You **reveal the world**, and the story **emerges** from play.
...
3. **Be Tropical Gothic** — The dead world is oppressive, overbearing, deadly. Corpses line streets, violence is permanent, heroes are half-dead starving warriors.
4. **Be Ultraviolent** — Kill everyone, even the important ones. Show brutal outcomes of love and loss. The World does not wait for the Wanderers.
...
- **Reveal The World** — New info, hidden secrets, lost manuals, ancient magicks
- **Let The World Move** — The other side's plan advances, enemies gain ground
- **Show The Rot** — That place of opulence is actually rotting, haunted, built on abomination
- **Let The World Speak** — The World speaks through Skills, Technicks, cryptic tones
- **Telegraph Ultraviolence** — Threaten resources, endanger what they hold dear, show incoming harm
...
- **Commit Ultraviolence** — Inflict damage, take resources, take Lore, take a Technick, kill NPCs
- **Tear Them Apart** — Separate players, force them to face things alone
- **A Faction Advances Its Agenda** — Any faction, any God, any Alignment
...
### World Being Discovery
Same as Wanderer discovery. Wanderers are ultimately World Beings too.

### Knocked Out
Reducing a WB to 0 = knocked out, incapacitated, unable to return to the fight.

### Prowess Tiers

| Symbol | Tier | Power | Health Modifier |
|---|---|---|---|
| ✦ | Weak | Not well-versed in combat | **Always 1 Health** |
| ★ | Standard | Equal to Wanderers | Normal |
| ★★ | Superior | Stronger, like 2 WBs | **×2 Health** |
| ⊕ | Strongest | Peerless combat skill | **×4 Health** |

### The 12 Patterns (Starting "Classes" for WBs)
Pre-built templates. CL 0 fighters with Attribute adjustments baked in:

1. **Swordsman** — Str 2, Skill 4, Mind 1, Wits 3, Mag 2, Psyche 1. Klem weapon.
2. **Ironclad** — Str 4, Skill 1, Mind 0, Wits 2, Mag 2, Psyche 3. Battleaxe + Shield.
3. **Ranger** — Str 1, Skill 3, Mind 1, Wits 4, Mag 1, Psyche 2. Bow.
4. **Mystic** — Str 1, Skill 2, Mind 3, Wits 3, Mag 2, Psyche 2. Battlestave + Magicks.
...
- **Flatten Choice** for WBs in combat — don't model them as tactical geniuses
- **Reward creativity** — A creative application of a Technick, genius wielding of a Skill, unexpected environmental use. The more unexpected, the more Real.
