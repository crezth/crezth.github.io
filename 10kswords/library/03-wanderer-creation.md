# Wanderer Creation & Character System
...
3. **Be On Your Own Side** — Skills, Magicks, Technicks are tools, not your identity.
4. **Open Your Eyes** — Interact with the world as if you are there. Trust the Intercessor.
5. **All You Meet Are Wanderers Too** — Treat NPCs as real people.
6. **Embody Ultraviolence** — When all else fails, evolve into violence.
7. **Death** — Some obstacles can't be overcome. Come back later or find a different way.
...
|---|---|
| Cultivation Level | 0 |
| Sidhi Strength | 3 × Realm |
| Health | 12 + CL + higher of Strength/Psyche |
| Carry | 8 |
| Mobility | 3 + Skill |
| Clarity | 0 |
| Magnetite | 3d6 mag |
...
### Strength
*Adamance, Violence, Labor*
Roll when you build, lift, break, or endure. The body's stubborn lovesong to itself.

### Skill
*Coordination, Movement, Dexterity*
Roll when you aim, dodge, steal, or move unseen. The distance between truth and power.

### Mind
*Dialectics, Composure, Rhetoric*
Roll to deduce, focus, reason, or remember. Mastery of logic and dialectics.

### Wits
*Perception, Reaction Speed, Deception*
Roll when you react, perceive, lie, or read intent. The art of the lie plausible.

### Magnetism
*Charisma, Bleeding Heart, Killing Intent*
Roll to inspire, persuade, or connect heart-to-heart. Fire-voice that makes men charge into death.
...
- **Dodge** = 6 + higher of Mind or Wits (all attacks)
- **Resolve** = 6 + higher of Magnetism or Psyche (mental/magick)

### Mobility
Capacity to cross space in 1-2 seconds. = 3 + Skill.

### Memory
Ability to remember and wield Magicks in intense situations. Starts at 6.

### Carry
Amount of things you can carry. Always starts at 8. Bags add more:
- Sidebag: +2
- Shoulderbag: +2
- Backpack: +4
...
- The new Wanderer can inherit the same Cultivations, Skills, etc. — or respec
- **The People are Immortal** — you cannot just keep taking from the Community
