# Shrine of the Black Bodhisattva — Adventure Module

> **Sources:** Shrine pp. 1–17

**Type:** Survival action horror minidungeon  
**Inspirations:** Bloodborne, Devil May Cry, Shin Megami Tensei III: Nocturne  
...
- Xozanji performs traumatic corpse-life surgery, experiments on orphans, stitches humans with demons
...
- **Search types:**
  - Quick Look (1 min) → General items only
  - Long Look (5 min) → General + Special items
  - Thorough Look (15 min) → General + Special + Secret items
...
- Items: 3× Talisman Paper "FIRE" (20+3d6mag, gives Blazing for 1 min), A Lune Key
- If Wanderers see Senzen's Forsaken Daughter form: **2 Clarity**
- **Senzen drops a Lunar Eye if slain** — eating it grants +1 Psyche permanently but necrotizes a body part and costs 1 Wits. Permanently see Spirits and Lunarfolk.

### Senzen, the Forsaken Daughter [Superior CL 3]
- Health 32, Sidhi 3, Parry 11, Dodge 7, Resolve 10
- Str 6, Skill 1, Mind 0, Wits 1, Mag 1, Psyche 4
...
### Capital Knight [Superior CL 2]
- Health 19, Armor 4, Str 6, Skill 6
- HaeCo Foldblade + Rectangle Shield
...
- **Trait: Moon Dancer** — Powered by a Lunarfiend. +1 Psyche, -1 Wits. Can use Psyche for weapon Attack Accuracy.
- **Technicks:** Vajra Guard, Devastating Red Hand, Gentle Lion Reversal, Raging River Fist
- **Magicks:** Celestial Cycle Rotation, Flare Mantra, Star Devouring Scathe
- **Equipment:** Abbot's Cowl (enter Samadhi after casting, once/day), Moon Robes (3 Sidhi for Magicks), Kungfu Boots
- **Attainments:** Inner Shrine, Mattatrun's Voice
- **Phases:** When he hits Bloody (36), he drinks the Lunar Elixir and becomes the **Actuarian of the Moon Immortal** — head bursts open, seven arms erupt
  - +Trait: Lunatic (2-in-6 chance on-hit: target loses 1 Clarity and 1 Psyche for a Round)
  - +Lunar Hollow Sutra Magick: Lunar Enlightenment Code (medium psychic damage to all non-aligned)
...
- **Wandering Dead [CL 1]:** Common Post-Calamity monsters. Corpses reanimated by lingering hateful ghosts. Deathform trait.
- **Beast-Men:** Ancient experiment by Mentra involving agitation of primal instinct within humans, turning them bestial
- **Lunarfiends:** Strange blossoming flower-like ghosts of silver flesh and mercury-blood. Change form. Only visible with Clarity 7+. Like giving gifts without considering repercussions.
- **Capital Knights:** Military soldiers of imperial forces. Forced standard: +1 Str, +1 Skill, -1 Mind, -1 Wits, -2 Psyche.
- **Shintai (God Altars):** Xozanji's experiments — humans stitched with demons, kept animate by horrid life-making needles. Used as juice to power his Immortality Elixir.
