...
**Karma** is the weight of a being's Sidhi — not souls, but the fluctuating mindstream. Intentional actions imprint upon atoms: heavier sidhis aggregate in worse rebirths, lighter sidhis in better ones.
...
**On entering Samadhi:**
- Immediately heal 1 Sidhi
- Gain +1 to a specific Attribute (defined by Cultivation Dialectic)
- Lasts for a number of Level ticks
- Enables the more powerful *Samadhi Technicks* of your Martial Art
...
**Important:** You cannot absorb the magnetite *within* items — those are exchange-values only. Actual Sidhi content of most items is ~1-2mag.
...
2. **Perform a Great Work** for a community (materially benefit the People)
...
|---|---|---|---|
| 1 | 0-2 | **Mortal** | Desire Realm |
| 2 | 3-4 | **Lightning Enterer** | Desire Realm |
| 3 | 5-6 | **Demifiend** | Form Realm |
| 4 | 7-8 | **Heavenly Soul** | Form Realm |
| 5 | 9-10 | **Nascent Immortal** | Formless Realm |
| 6 | 11-12 | **Vajra Essence** | Formless Realm |

- **Mortals** (0-2): Everyone starts here. Due to Five-Armed Demiurge Array, nobody goes above this without undergoing the Antinomian Rite.
- **Lightning Enterer** (3-4): Advanced technicks and magicks. Cultivation Womb opens.
- **Demifiend** (5-6): On par with demigods and young Immortals. Most common ceiling for Cultivators.
- **Heavenly Soul** (7-8): Same power as lower Gods of the Astral Bureaucracy. Can leap to other planets.
...
The Rite is different for every Cultivator. Examples include:
- Eating the preserved liver of an old Revolutionary
- Changing one's sex
- Swallowing a fragment of an ancient Magnetite Shard
- Consummating or breaking a marriage that ruptures the Array
...
### Divine Empowerment: Bolster
Strengthens the self. Minor Strain.
- +2 on Strength Checks
- On melee hit: +2 damage, knockback 1 + Strength hexes

### Divine Empowerment: Lightness
Manipulate weight. Minor Strain.
- Leaping/moving into a wall: free 1hx movement in any direction
- Minor Strain: move 5hx straight line in any direction (even floating)
- Halve fall damage by suffering Minor Strain
