...
| Tick | 3 seconds |
| Round | 1 minute |
| Incense | 10 minutes (searching thoroughly) |
| Phase | 8 hours (travel and rest) |
| Day | 24 hours (full sun and full moon) |
| Week | 7 days |
| Month | 30 days (full lunar cycle) |
...
| Shape | Description |
|---|---|
| Line X | Straight line, X hexes long. Normally 1hx wide, can grow. |
| Blast X | Triangular cone from adjacent point/hex. X hexes wide at end, X hexes long. |
...
- **Carbs:** White/black/brown rice, taro, sweet potato, potato, millet, coconut rice
- **Proteins:** Sardines, milkfish, tilapia, squid, octopus, chicken, pork, beef, carabao, eggs, mushrooms
...
- **On greater mounts (Skyships, Divine Horses, Devil Tigers):** Halve time
...
| Object Type | Durability | Size |
|---|---|---|
| Items (really small) | ~1 DR | Tiny |
| Small/thin objects | 3 DR | 1hx tall, wide |
| Medium objects (doors, walls, tables) | 2+d6 DR | 1-2hx wide, tall |
...
- **More items than Carry = Encumbered** (can still carry, but significant disadvantages)
- Max 2 bags:
  - Sidebag: +2 slots
  - Shoulderbag: +2 slots
  - Backpack: +4 slots
- If bag is removed, items in it are gone too
